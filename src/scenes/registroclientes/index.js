...
const peticionGetTipoCli = async () =>{
  ...
  const peticionPost=async()=>{
    ...
    await axios.post(baseUrlPost, nuevoCliente, config)
    .then(response=>{
  ...
  const peticionPut=async()=>{
    ...
    await axios.put(baseUrlPut+nuevoCliente.cli_clave, nuevoCliente, config)
    .then(response=>{
      var dataNueva=data;
  ...
  const peticionDelete=async()=>{
    ...
    await axios.delete(baseUrlDelete+nuevoCliente.cli_clave, config)
    .then(response=>{
      setData(data.filter(consola=>consola.cli_clave!==nuevoCliente.cli_clave));
...
const bodyInsertar = (
  <div style={{
    ...
    >
      ...
      <TextField  margin="normal" name="cli_nomcom" label="Nombre" onChange={handleChange} />
      <TextField  margin="normal" name="cli_correo" label="Correo" onChange={handleChange} />
      <TextField  margin="normal" name="cli_cel" label="Celular" onChange={handleChange}/>
...
const bodyEditar = (
  <div style={{
    ...
    >
      ...
      <TextField  margin="normal" name="cli_nomcom" label="Nombre" onChange={handleChange} value={nuevoCliente && nuevoCliente.cli_nomcom}/>
      <TextField  margin="normal" name="cli_correo" label="Correo" onChange={handleChange} value={nuevoCliente && nuevoCliente.cli_correo}/>
      <TextField  margin="normal" name="cli_cel" label="Celular" onChange={handleChange} value={nuevoCliente && nuevoCliente.cli_cel}/>
      <br/>
      <FormControl fullWidth>
      <InputLabel id="demo-simple-select-dos">Tipo de Cliente</InputLabel>
      <Select
...
const bodyEliminar=(
  ...
  <Box m="10px"   sx={{
    ...
    <p>Estás seguro que deseas eliminar al Cliente <b>{nuevoCliente && nuevoCliente.cli_nomcom}</b> ? </p>
