...
const peticionGetEmpresas = async () =>{
    ...
    const peticionPost=async()=>{
      ...
      await axios.post(baseUrlPost, nuevoTipoUsuario, config)
      .then(response=>{
    ...
    const peticionPut=async()=>{
      ...
      await axios.put(baseUrlPut+nuevoTipoUsuario.tip_clave, nuevoTipoUsuario, config)
      .then(response=>{
        var dataNueva=data;
    ...
    const peticionDelete=async()=>{
      ...
      await axios.delete(baseUrlDelete+nuevoTipoUsuario.tip_clave, config)
      .then(response=>{
        setData(data.filter(consola=>consola.tip_clave!==nuevoTipoUsuario.tip_clave));
...
const bodyInsertar = (
    <div style={{
      ...
      >
        ...
        <TextField  margin="normal" name="tip_nom" label="Nombre" onChange={handleChange} />
        <TextField  margin="normal" name="tip_desc" label="Descripcion" onChange={handleChange} />
  ...
  const bodyEditar = (
    <div style={{
      ...
      >
        ...
        <TextField  margin="normal" name="tip_nom" label="Nombre" onChange={handleChange} value={nuevoTipoUsuario && nuevoTipoUsuario.tip_nom}/>
        <TextField  margin="normal" name="tip_desc" label="Descuento" onChange={handleChange} value={nuevoTipoUsuario && nuevoTipoUsuario.tip_desc}/>
  ...
  const bodyEliminar=(
    ...
    <Box m="10px"   sx={{
      ...
      <p>Estás seguro que deseas eliminar el Tipo de Usuario <b>{nuevoTipoUsuario && nuevoTipoUsuario.tip_nom}</b> ? </p>
